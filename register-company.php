                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control input-lg" type="password" name="cpassword"  id="cpassword"
                                        ...
                                        <div id="passwordError" class="text-danger text-center hide-me" style="visibility: hidden;">
                    Password Mismatch!!
                  </div>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <button class="btn btn-lg btn-block" type="submit" name="submit">Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
