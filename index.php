                            ...
                            <div class="col-xl-8">
                                ...
                                <form action="" method="GET" class="search-box">
                                    <div class="input-form">
                                        <input type="text" name="keyword" placeholder="Job Title or keyword" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : ''; ?>">
                                    </div>
                                    <div class="select-form">
                                        <div class="select-itms">
                                            <select name="location" id="select1">
                                                <option value="">Select Location</option>
                                                <option value="Karachi" <?php if (isset($_GET['location']) && $_GET['location'] == 'Karachi') echo 'selected'; ?>>Location Karachi</option>
                                                <option value="Lahore" <?php if (isset($_GET['location']) && $_GET['location'] == 'Lahore') echo 'selected'; ?>>Location Lahore</option>
                                                <option value="Islamabad" <?php if (isset($_GET['location']) && $_GET['location'] == 'Islamabad') echo 'selected'; ?>>Location Islamabad</option>
                                            </select>
                                        </div>
                                    </div>
        ...
        <div class="container mt-5">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    if (!$result) {
                        // If query failed, display the MySQL error
                                            ...
                                            <div class="job-items">
                                                ...
                                                <div class="job-tittle ml-3">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li id="jt"><i class="fas fa-map-marker-alt"></i><?php echo $row['location']; ?></li>
                                                        <li>Experience <?php echo $row['experience']; ?> Years</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="items-link f-right"> 
                                                <a style="background-color: #fb246a; color:white; border:0px;" href="view-job-post.php?id=<?php echo $row['id_jobpost'];  ?>" >Full details</a>
                                            </div>
                                        </div>
                    <?php
                                    }
                            ...
                            echo "<p align='center' class='fw-bold h1 text-danger'>No jobs found matching your criteria.</p>";
                        }
                    }
                    ?>
